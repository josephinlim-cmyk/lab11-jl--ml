...
class TestCalculator(unittest.TestCase):
    ...
    def test_logarithm(self): # 3 assertions
        self.assertAlmostEqual(logarithm(2, 8), 3.0, places=5)
        self.assertAlmostEqual(logarithm(10, 100), 2.0, places=5)
        self.assertAlmostEqual(logarithm(5, 25), 2.0, places=5)
